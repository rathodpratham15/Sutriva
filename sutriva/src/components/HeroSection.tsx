...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate, onOpenDemo }) => {
  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden bg-grid-pattern border-b border-zinc-800/60">
      ...
      <div className="absolute top-1/3 right-10 w-[400px] h-[300px] glow-cyan pointer-events-none -z-10 opacity-60" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900/90 border border-zinc-700/60 text-xs font-mono text-zinc-300 shadow-sm">
            ...
            <span className="text-emerald-400 font-semibold">sutriva@0.1.1</span>
          </div>
        ...
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-zinc-400 font-normal leading-relaxed max-w-3xl mx-auto">
            Debugging often depends on what happened <span className="text-zinc-200 font-medium underline decoration-emerald-500/40 underline-offset-4">before</span> the current state. Sutriva turns live and recorded debugging sessions into persistent, timestamped evidence that coding agents can query later.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mb-14">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-lg bg-emerald-400 hover:bg-emerald-300 text-zinc-950 font-semibold text-sm transition-all shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/25 active:scale-95"
          >
          ...
          <button
            ...
            onClick={onOpenDemo}
            className="flex items-center gap-2 px-5 py-3 rounded-lg bg-zinc-900/40 hover:bg-zinc-800/80 text-zinc-300 hover:text-emerald-300 border border-zinc-800 font-medium text-sm transition-colors"
          >
            ...
            {activeHeroTab === 'terminal' && (
              <div className="space-y-3">
                ...
                <div className={`transition-opacity duration-300 ${animationStep >= 2 ? 'opacity-100' : 'opacity-30'}`}>
                  ...
                  <div className="text-zinc-400 text-xs pl-4 border-l-2 border-emerald-900/60 mt-1">
                ...
                {animationStep >= 4 ? (
                  <div className="p-3 rounded-lg bg-zinc-900/90 border border-emerald-500/30 text-xs space-y-1.5 animate-fadeIn">
                    <div className="flex items-center justify-between text-emerald-400 font-medium">
                      <span className="flex items-center gap-1.5">
                        <Clock className="w-3.5 h-3.5" />
                        Evidence around 14.82s
                      </span>
                      <span className="text-[11px] px-1.5 py-0.5 rounded bg-red-950/80 text-red-400 border border-red-800/60">
                        Uncaught TypeError (200 response)
                      </span>
                    </div>
                    <p className="text-zinc-300">
                      Root cause: <code className="text-amber-300 bg-zinc-950 px-1 py-0.5 rounded">app/checkout/page.tsx:15</code> — <span className="text-zinc-400">the API returns `id`, not `orderId` — a response schema mismatch</span>
                    </p>
            ...
            {activeHeroTab === 'evidence' && (
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-2.5 rounded bg-red-950/40 border border-red-800/60 text-xs flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-red-400 font-mono font-bold">14.91s</span>
                      <span className="text-red-300 font-mono font-bold">Uncaught TypeError</span>
                    </div>
                    <span className="text-red-400 font-mono text-[10px] bg-red-950 px-1.5 py-0.5 rounded border border-red-800">
                      page.tsx:15
                    </span>
                  </div>
            ...
            {activeHeroTab === 'mcp' && (
              <div className="space-y-2">
                <div className="text-[11px] text-zinc-400 flex items-center justify-between">
                  <span>MCP tool call: <code className="text-emerald-400">get_evidence</code></span>
      ...
      "source": { "file": "app/checkout/page.tsx", "line": 15 }
            ...
            <div className="pt-3 mt-3 border-t border-zinc-800/70 flex flex-wrap items-center justify-between text-xs text-zinc-400">
              ...
              <div className="flex items-center gap-4 text-zinc-400">
                ...
                <span className="text-emerald-400 cursor-pointer hover:underline" onClick={onOpenDemo}>
        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-xl bg-zinc-900/40 border border-zinc-800/80 text-center">
            <div className="text-2xl font-mono font-bold text-emerald-400 mb-1">Local-First</div>
            <div className="text-xs text-zinc-400">SQLite persistence</div>
          </div>
          <div className="p-4 rounded-xl bg-zinc-900/40 border border-zinc-800/80 text-center">
            <div className="text-2xl font-mono font-bold text-cyan-400 mb-1">MCP Ready</div>
            <div className="text-xs text-zinc-400">Open Model Context Protocol</div>
          </div>
          <div className="p-4 rounded-xl bg-zinc-900/40 border border-zinc-800/80 text-center">
            <div className="text-2xl font-mono font-bold text-amber-400 mb-1">10 Tools</div>
